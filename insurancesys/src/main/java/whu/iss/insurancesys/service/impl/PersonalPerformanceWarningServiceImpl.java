    ...
    public PersonalPerformanceWarningQueryResult query(long number, String insuranceKind, Date baseMonth, String project, String category, String period) {
        ...
        if (insuranceKind.equals("寿险")) {
            ...
            for (LifeInsuranceFyc item : lifeInsuranceFycs) {
                ...
                LifeInsuranceCheckDetail lifeInsuranceCheckDetail = new LifeInsuranceCheckDetail(item.getPolicyNo(), project, category, value);
            ...
            for (CarInsuranceFyc item : carInsuranceFycs) {
                ...
                CarInsuranceCheckDetail carInsuranceCheckDetail = new CarInsuranceCheckDetail(item.getPolicyNo(), project, category, value);
